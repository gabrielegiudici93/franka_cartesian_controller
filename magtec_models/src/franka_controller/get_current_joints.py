...
def main():
    ...
    try:
        ...
        print()
        print("Format for hardware.yaml / code:")
        ...
        print("Current cartesian position (m):")
        print(f"   X: {current_position[0]:.6f}")
        print(f"   Y: {current_position[1]:.6f}")
        print(f"   Z: {current_position[2]:.6f}")
        print()
        print("Values ready to copy into config/hardware.yaml")
