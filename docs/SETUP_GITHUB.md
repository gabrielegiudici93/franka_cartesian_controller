...
git remote add origin https://github.com/<YOUR_ORG>/franka_cartesian_controller.git
git branch -M main
...
This means a collaborator can clone and build without any external lab repo.

## Sample data (optional)

If you want collaborators to have a working demo dataset:
...
Otherwise keep `data/` empty (just `.gitkeep`) and document where to download.
